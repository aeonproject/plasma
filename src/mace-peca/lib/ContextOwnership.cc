...
void ContextStructure::updateOwnerships( const mace::vector< mace::pair<mace::string, mace::string> >& ownerships, const mace::map<mace::string, uint64_t>& vers ) {
...
mace::vector< mace::pair<mace::string, mace::string> > ContextStructure::getOwnershipOfContexts( const mace::set<mace::string>& contexts ) const {
  ADD_SELECTORS("ContextStructure::getOwnershipOfContexts");
  mace::vector< mace::pair<mace::string, mace::string> > ownerships;
