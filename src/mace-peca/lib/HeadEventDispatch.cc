...
namespace HeadEventDispatch {
  ...
  void HeadEventTP::executeGlobalContextCreateEventProcess() {
    ...
    std::pair< mace::MaceAddr, uint32_t > newMappingReturn = contextMapping.newMapping(e->createContextName, e->newAddr);
  ...
  */
  ...
  void HeadEventTP::tryWakeupGlobal(){
    ...
    HeadCreateContextEvent* helper = new HeadCreateContextEvent(ctxName, eventId, new_addr, ownershipPairs, vers);
