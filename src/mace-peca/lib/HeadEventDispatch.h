...
namespace HeadEventDispatch {
  ...
  public:
    ...
    mace::MaceAddr newAddr;
    mace::vector< mace::pair<mace::string, mace::string> > ownershipPairs; 
    mace::map< mace::string, uint64_t> vers;
    
    HeadCreateContextEvent(): createContextName(""), eventId(), newAddr(), ownershipPairs(), vers() { }

    HeadCreateContextEvent(const mace::string& ctxName, const mace::OrderID& eventId, const mace::MaceAddr& new_addr,
      const mace::vector< mace::pair<mace::string, mace::string> >& ownershipPairs, const mace::map< mace::string, uint64_t>& vers ): 
      createContextName(ctxName), eventId(eventId), newAddr(new_addr), ownershipPairs(ownershipPairs), vers(vers) { }
